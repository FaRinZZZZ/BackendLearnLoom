...
def getNodeFromPDF(pdf):
    ...
    for i in msg.split("\n"):
        ...
        try:
            ...
            continue
    if(valid): print(node)
    else: print("Invalid response from Typhoon")
